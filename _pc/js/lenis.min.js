!(function (t, e) {
  ...
  class Animate {
    ...
    fromTo(t, e, { lerp: i = 0.1, duration: o = 1, easing: s = (t) => t, onStart: n, onUpdate: r }) {
  ...
  class Dimensions {
    constructor({ wrapper: t, content: e, autoResize: i = !0, debounce: o = 250 } = {}) {
      (this.wrapper = t),
        (this.content = e),
        i &&
      ...
      (this.__isSmooth = !1),
        ...
        (this.onVirtualScroll = function (t) {
          ...
          if (!o.ctrlKey) {
            ...
            if (P.options.syncTouch && s && "touchstart" === o.type && !P.isStopped && !P.isLocked) P.reset();
            else {
              var r = 0 === e && 0 === i,
                l =
              ...
              if (!r && !l) {
                ...
                if (
                  !(h = h.slice(0, h.indexOf(P.rootElement))).find(function (t) {
                    var e, i, o, r, l;
                    return (
                      ...
                      ((null === (r = t.classList) || void 0 === r ? void 0 : r.contains("lenis")) &&
                        !(null === (l = t.classList) || void 0 === l ? void 0 : l.contains("lenis-stopped")))
                    );
                  })
                )
                  if (P.isStopped || P.isLocked) o.preventDefault();
                  else {
                    if (((P.isSmooth = (P.options.syncTouch && s) || (P.options.smoothWheel && n)), !P.isSmooth))
                      return (P.isScrolling = !1), void P.animate.stop();
                    o.preventDefault();
                    var a = i;
                    "both" === P.options.gestureOrientation
                      ? (a = Math.abs(i) > Math.abs(e) ? i : e)
                      : "horizontal" === P.options.gestureOrientation && (a = e);
                      ...
                      P.scrollTo(
                        ...
                        __assign(
                          ...
                          c
                            ...
                            : { lerp: P.options.lerp, duration: P.options.duration, easing: P.options.easing }
                        )
                      );
                  }
              }
        ...
        (this.emitter = new Emitter()),
        (this.dimensions = new Dimensions({ wrapper: o, content: n, autoResize: k })),
        ...
        (this.virtualScroll = new VirtualScroll(a, { touchMultiplier: W, wheelMultiplier: H })),
      ...
      (Lenis.prototype.scrollTo = function (t, e) {
        ...
        if ((!this.isStopped && !this.isLocked) || S) {
          if (["top", "left", "start"].includes(t)) t = 0;
            ...
            var b = void 0;
            if (
              ("string" == typeof t ? (b = document.querySelector(t)) : (null == t ? void 0 : t.nodeType) && (b = t), b)
            ) {
